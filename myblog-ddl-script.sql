...
(9,'Keyboard instrument with a series of keys that are pressed to produce sound', 'Piano', NOW(), NOW()),
(10,'Flute instrument that produces sound by directing a stream of air across a hole in the instrument', 'Flute', NOW(), NOW());
